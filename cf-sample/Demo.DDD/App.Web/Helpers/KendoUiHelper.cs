    ...
    public static class KendoUiHelper
    {
        ...
        private static KendoUiGridResult<T> ReturnGridData<T>(KendoUiGridParam requestParam, ref IQueryable<T> collection)
        {
            ...
            try
            {
                ...
                gridData = collection.Take(requestParam.PageSize).ToList();
            }
            catch
            {
        ...
        public static string KendoUIGridActionLinkGenerate(string areaName, string controllerName, string id, bool isDetailPermitted = true, bool isEditPermitted = true, bool isDeletePermitted = true)
        {
            ...
            {
                //Details Link
                strLink += @" <a class='lnkDetailCommon" + controllerName + "' href='" + urlDetails + "' title='Details' >Details</a>&nbsp;&nbsp;";
            }

            if (isEditPermitted)
            {
                //Edit Link
                strLink += "<a class='lnkEditCommon" + controllerName + " ' href='" + urlEdit + "' title='Edit' >Edit</a>&nbsp;&nbsp;";
            }

            if (isDeletePermitted)
            {
                //Delete Link
                strLink += "<a class='lnkDeleteCommon" + controllerName + "' href='" + urlDelete + "' title='Delete' >Delete</a>";
            }
