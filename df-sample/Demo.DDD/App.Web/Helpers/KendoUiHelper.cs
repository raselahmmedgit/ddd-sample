...
namespace App.Web.Helpers
{
    public static class KendoUiHelper
    {
        ...
        public static string KendoUIGridActionLinkGenerate(string areaName, string controllerName, string id, bool isDetailPermitted = true, bool isEditPermitted = true, bool isDeletePermitted = true)
        {
            ...
            {
                //Details Link
                strLink += @" <a class='lnkDetailCommon' href='" + urlDetails + "' title='Details' >Details</a>&nbsp;&nbsp;";
            }

            if (isEditPermitted)
            {
                //Edit Link
                strLink += @"<a class='lnkEditCommon' href='" + urlEdit + "' title='Edit' >Edit</a>&nbsp;&nbsp;";
            }

            if (isDeletePermitted)
            {
                //Delete Link
                strLink += @"<a class='lnkDeleteCommon' href='" + urlDelete + "' title='Delete' >Delete</a>";
            }
